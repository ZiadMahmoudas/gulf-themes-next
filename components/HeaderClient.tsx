...
export function HeaderClient({ whatsappHref, socials }: Props) {
    ...
    <header className={`v13-header${scrolled ? " is-scrolled" : ""}`}>
      ...
      <div className="shell v13-nav">
        ...
        <div className="v13-nav-actions">
          ...
          <a className="v13-whatsapp" href={whatsappHref} target="_blank" rel="noreferrer">
            <span className="v13-live-dot" />واتساب
          </a>
          <MobileMenu whatsappHref={whatsappHref} socials={socials} />
        </div>
      </div>
    </header>
  );
